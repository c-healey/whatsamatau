  ...
  <div class="hero-slider">
     <?php 
        ...
        while ($homepageSlides->have_posts()){
          ...
          <div class="hero-slider__slide" style="background-image: url(<?php the_field('slide_photo'); ?>);">
          <div class="hero-slider__interior container">
            <div class="hero-slider__overlay">
              ...
              <p class="t-center no-margin"><a href="<?php the_permalink(); ?>" class="btn btn--blue"><?php the_field('slide_link_text'); ?></a></p>
            </div>
          </div>
        </div>
<?php } wp_reset_postdata();
